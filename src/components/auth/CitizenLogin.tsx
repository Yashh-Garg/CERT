      ...
      <div className="bg-card border border-border rounded-lg shadow-card p-6 md:p-8">
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-foreground mb-1">
            {showForgot ? 'Forgot Login Id' : 'Login'}
          </h2>
          <p className="text-sm text-muted-foreground">
            {showForgot ? 'Recover your Login ID using mobile OTP' : 'Securely access your account'}
          </p>
        </div>

        {showForgot ? (
          <ForgotLoginId onBack={() => setShowForgot(false)} hideHeader />
        ) : (
        <Form {...form}>
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    className="h-10 focus-visible:ring-2 focus-visible:ring-ring"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
                ...
                <div className="flex gap-2">
                  ...
                  <FormControl>
                    <Input
                      ...
                      maxLength={10}
                      className="flex-1 h-10 focus-visible:ring-2 focus-visible:ring-ring"
                    />
                  </FormControl>
                  <Button
                    type="button"
                    onClick={handleGetOtp}
                    className="bg-security hover:bg-security/90 text-security-foreground px-4 h-10 shadow-security"
                  >
                    Get OTP
                  </Button>
                </div>
          ...
          />
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button
                type="submit"
                className="flex-1 bg-security hover:bg-security/90 text-security-foreground shadow-security"
              >
                Submit
              </Button>
            </div>
        ...
        <div className="text-center mt-4 text-sm">
          ...
          <a href="/auth" className="text-primary no-underline hover:no-underline">
